export const landing = {
  ...
  ticker: {
    ...
    items: [
      ...
      { variant: 'muted' as const, text: 'Avg readiness this week · 16 / 50' },
      { variant: 'teal' as const, dot: true, text: 'POPIT · People · 4 / 10' },
      { variant: 'amber' as const, dot: true, text: 'Gap Analysis' },
      { variant: 'muted' as const, text: 'Reports generated · 24/7' },
      { variant: 'coral' as const, dot: true, text: 'Top risks flagged' },
      { variant: 'teal' as const, dot: true, text: 'Median time to first report · 15 min' },
      { variant: 'signal' as const, dot: true, text: 'Top assets shown' },
      { variant: 'amber' as const, dot: true, text: 'FREE' },
      { variant: 'muted' as const, text: 'v1.2 · Building Publicly' },
    ],
  },

  hero: {
    eyebrow: { tag: 'v1.2 · Building Publicly', variant: 'signal' as const },
    titlePre: 'The readiness tool ',
    titleEm: 'for deep-tech ',
    titlePost: 'researchers and founders.',
    ...
    meta: [
      { label: 'Built for', value: "University Spinouts · Founders · Researchers" },
      { label: 'Frameworks', value: 'POPIT · SWOT · Stakeholder Analysis' },
      { label: 'Output', value: 'One-page brief' },
    ],
    sampleScore: {
      total: 24,
      outOf: 50,
      ...
      scores: [
        { label: 'PROBLEM', value: 3, outOf: 10 },
        { label: 'MARKET', value: 3, outOf: 10 },
        { label: 'COMPETITION', value: 6, outOf: 10 },
        { label: 'TEAM', value: 4, outOf: 10 },
        { label: 'RISK', value: 3, outOf: 10 },
        { label: 'EVIDENCE', value: 5, outOf: 10 },
      ],
    },
  },
...
// 'UCL', "King's College London", 'University of Oxford', 'University of Cambridge',
  ...
  threeActs: {
    number: '02',
    label: 'How it works',
    titlePre: 'Three phases.',
    titleEm: 'One clear picture.',
    description: 'Lab²Launch runs your inputs through BA frameworks — POPIT, SWOT, Stakeholder Analysis — and surfaces the gaps investors will find before it\'s too late.',
    acts: [
      {
        letter: '1',
        number: 'Act 1 · Stress test',
        title: 'Just a few questions',
        body: "You answer the questions every investor will ask, and will then respond to follow up questions.",
        bullets: [
          { pop: '-', text: 'What pain are you solving?' },
          { pop: '-', text: 'What is your route to market?' },
          { pop: '-', text: 'What does your team bring that others cannot replicate?' },
          { pop: '-', text: 'What evidence exists that customers will pay?' },
          { pop: '-', text: 'What risks have you not yet named?' },
        ],
      },
      {
        letter: '2',
        ...
        bullets: [
          { pop: '-', text: 'Problem clarity · Is the pain economic or safety-critical?' },
          { pop: '-', text: 'Market evidence · Bottom-up TAM with customer discovery' },
          { pop: '-', text: 'Competitive position · Genuine moat vs feature parity' },
          { pop: '-', text: 'Team & execution · Right skills, governance, advisors' },
          { pop: '-', text: 'Risk awareness · Sector-specific risks named and mitigated' },
        ],
        featured: true,
      },
      {
        ...
        body: "You leave with a prioritised action list. Not generic advice, but specific, testable steps ranked by investor impact, with a first action for this week.",
        bullets: [
    ...
    stages: [
      {
        ...
        description: "A one-paragraph summary written for your neighbour or parents — no jargon, no acronyms.",
      },
      {
        num: '02',
    ...
    audiences: [
      {
        ...
        features: ['Gap analysis in 15 minutes', 'Plain English summary of your science', 'Actionable steps ranked by investor impact'],
      },
      {
  ...
  cta: {
    ...
    body: "Run a free analysis in 15 minutes. Get a structured gap analysis, a plain-English summary of your science, and three specific actions ranked by investor impact.",
    primaryCta: { label: 'Run a free analysis', href: '/analyse' },
    secondaryCta: { label: 'See a sample report', href: '#sample' },
